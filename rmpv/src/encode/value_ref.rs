...
/// value. 
#[cfg(feature = "std")]
/// Interruption errors are handled internally by silent operation restarting.
///
/// # Examples
/// ```
/// use rmpv::ValueRef;
...
/// ```
#[cfg(feature = "std")]
pub fn write_value_ref<W>(wr: &mut W, val: &ValueRef<'_>) -> Result<(), ValueWriteError<W::Error>>
    where W: RmpWrite
{
    match *val {
        ValueRef::Nil => {
...
/// No-std version of write_value_ref
#[cfg(not(feature = "std"))]
pub fn write_value_ref<W>(wr: &mut W, val: &ValueRef<'_>) -> Result<(), ValueWriteError<W::Error>>
    where W: RmpWrite
{
